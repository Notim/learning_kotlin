...
<xsl:variable name="WordsFormat">Em Palavras</xsl:variable>

<!-- _locID_text="BytesFormat" -->
<xsl:variable name="BytesFormat">Em Bytes</xsl:variable>
...
<xsl:when test="descendant::*[contains(local-name(), 'Binary')]">
  ...
  <xsl:variable name="BinaryDataCaption">Dados binários:</xsl:variable>
